...
exports.govtSchemes = void 0;
exports.govtSchemes = [
    {
        id: 'raw-material-supply',
        name: 'Raw Material Supply Scheme',
        description: 'Government scheme enabling weavers to procure high-quality raw materials like yarn, dyes, and chemicals at subsidised prices through co-operative societies.',
        benefits: [
    ...
    },
    {
        ...
        description: 'Direct cash subsidy to handloom weavers for purchase of cotton, silk, and wool yarn, reducing input cost and supporting traditional textile production.',
        benefits: [
    ...
    },
    {
        ...
        description: 'Provides solar-powered loom systems to weavers to reduce electricity dependency, support sustainable production, and reduce operational costs by up to 60%.',
        benefits: [
    ...
    },
    {
        ...
        description: 'Flagship government programme for comprehensive development of handloom sector including infrastructure, skill training, design development, and market access.',
        benefits: [
    ...
    },
    {
        ...
        description: `Training programme under Weavers' Service Centres to upgrade weaving skills, introduce new designs, modern techniques, and quality standards for domestic and export markets.`,
        benefits: [
